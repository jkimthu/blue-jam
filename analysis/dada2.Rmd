...
taxa <- assignTaxonomy(seqtab.nochim, here("data", "database", "silva_nr99_v138.1_train_set.fa.gz"), multithread=TRUE)
```
...
Less truncation gave 21 sample species in Mock Community whereas more truncation gives 29!
