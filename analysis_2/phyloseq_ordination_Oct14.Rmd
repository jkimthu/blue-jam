...
plot_ordination(ps.prop, ord.nmds.bray, color ="Extraction", shape = "Replicate",  title="Bray NMDS") +
  geom_point(size=2)
```
...
# Bray-Curtis ordination
plot_ordination(ps.prop, ord.nmds.bray3, color="Location", shape = "Mouse", title="Bray PCoA")+
  geom_point(size=2)
```
...
# Bray-Curtis ordination
plot_ordination(ps.prop2, ord.nmds.bray4, color="Location", shape = "Mouse", title="Bray PCoA")+
  geom_point(size=2)
```

```{r 2.3 Bray Curtis, PCoA: mucus and tissue only, identifying gentle vs hard}
plot_ordination(ps.prop2, ord.nmds.bray4, color ="Extraction", shape = "Replicate",  title="Bray PCoA") +
  geom_point(size=2)
```