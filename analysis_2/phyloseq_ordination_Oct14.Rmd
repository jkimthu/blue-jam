---
title: "ordination plots for re-sequenced data received Oct 14"
author: "jen nguyen"
date: "10/25/2021"
...
seqtab.nochim <- readRDS(here("output","dada2_20211014","seqtable_nochimeras_oct14.rds")) # sequence table w/o chimeras
...
plot_ordination(ps.prop, ord.nmds.bray, color="Location", shape = "Mouse", title="Bray NMDS, 2nd seq")+
  geom_point(size=2)
```
...
# Bray-Curtis ordination
plot_ordination(ps.prop2, ord.nmds.bray2, color="Location", shape = "Mouse", title="Bray NMDS, 2nd seq")+
  geom_point(size=2)
```


```{r 1.3 Bray Curtis, part 3: mucus and tissue only, identifying gentle vs hard}
plot_ordination(ps.prop, ord.nmds.bray, color ="Extraction", shape = "Replicate",  title="Bray NMDS, 2nd seq") +
  geom_point(size=2)
```
...
# Bray-Curtis ordination
plot_ordination(ps.prop, ord.nmds.bray3, color="Location", shape = "Mouse", title="Bray PCoA, 2nd seq")+
  geom_point(size=2)
```
...
# Bray-Curtis ordination
plot_ordination(ps.prop2, ord.nmds.bray4, color="Location", shape = "Mouse", title="Bray PCoA, 2nd seq")+
  geom_point(size=2)
```

```{r 2.3 Bray Curtis, PCoA: mucus and tissue only, identifying gentle vs hard}
plot_ordination(ps.prop2, ord.nmds.bray4, color ="Extraction", shape = "Replicate",  title="Bray PCoA, 2nd seq") +
  geom_point(size=2)
```