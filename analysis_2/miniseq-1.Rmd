...
```{r load dada2 outputs, minidada_1}
seqtab <- readRDS(here("output","minidada_1","seqtable_1.rds")) # raw sequence table
seqtab.nochim <- readRDS(here("output","minidada_1","seqtable_nochimeras_1.rds")) # sequence table w/o chimeras
taxa <- readRDS(here("output","minidada_1","taxonomic_assignments_1.rds")) # taxonomic assignments
```
